...
def epand_plot_score(x_count, data, x_lim = None, y_lim = None, x_ticks = None, x_label = 'EPOCH', y_label = 'score', title = 'score', legend = ['train', 'test'], filename = 'test'):
...
def plot_one(epoch, data, x_lim = None, y_lim = None, x_label = 'EPOCH', y_label = 'score', title = 'score', filename = 'test'):
    plt.figure(figsize=(6,6))
